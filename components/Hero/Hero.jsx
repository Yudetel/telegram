        ...
        <div ref={wrapperRef} className={styles.hoverWrapper}>
          <div className={styles.overlay}>
            ...
            <p className={styles.animatedTextP}>
              {"Створюй і керуй сучасними ботами без кодування. Легко додавай команди, керуй діалогами, інтегруй з іншими сервісами і роби ботів по-справжньому розумними."
                .split(" ")
                .map((word, wIndex) => (
                  <span
                    key={wIndex}
